...
<%
    ...
    String noticeTitle = (String)request.getAttribute("noticeTitle"); //标题查询关键字
    String noticeClass = (String)request.getAttribute("noticeClass"); //公告类别查询关键字
    String addDate = (String)request.getAttribute("addDate"); //发布日期查询关键字
%>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#noticeListPanel" aria-controls="noticeListPanel" role="tab" data-toggle="tab">公告信息列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Notice/notice_frontAdd.jsp" style="display:none;">添加公告信息</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>公告id</td><td>标题</td><td>公告类别</td><td>发布日期</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<noticeList.size();i++) {
					    	            		...
					    	            		Notice notice = noticeList.get(i); //获取到公告信息对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="noticeQueryForm" id="noticeQueryForm" action="<%=basePath %>Notice/frontlist" class="mar_t15" method="post">
			<div class="form-group">
				...
				<input type="text" id="noticeTitle" name="noticeTitle" value="<%=noticeTitle %>" class="form-control" placeholder="请输入标题">
			</div>
			...
			<div class="form-group">
				<label for="noticeClass">公告类别:</label>
				<input type="text" id="noticeClass" name="noticeClass" value="<%=noticeClass %>" class="form-control" placeholder="请输入公告类别">
			</div>
			...
			<div class="form-group">
				<label for="addDate">发布日期:</label>
				<input type="text" id="addDate" name="addDate" class="form-control"  placeholder="请选择发布日期" value="<%=addDate %>" onclick="SelectDate(this,'yyyy-MM-dd')" />
			</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			 	<textarea name="notice.noticeContent" id="notice_noticeContent_edit" style="width:100%;height:500px;"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
...
<script>
//实例化编辑器
var notice_noticeContent_edit = UE.getEditor('notice_noticeContent_edit'); //公告内容编辑器
	...
	$.ajax({
		...
		success : function (notice, response, status) {
			if (notice) {
				...
				notice_noticeContent_edit.setContent(notice.noticeContent, false);
