		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#leavewordListPanel" aria-controls="leavewordListPanel" role="tab" data-toggle="tab">公共留言列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Leaveword/leaveword_frontAdd.jsp" style="display:none;">添加公共留言</a></li>
				</ul>
			  	<!-- Tab panes -->
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
				    	            		...
				    	            		for(int i=0;i<leavewordList.size();i++) {
					    	            		...
					    	            		Leaveword leaveword = leavewordList.get(i); //获取到公共留言对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;公共留言信息编辑</h4>
      </div>
