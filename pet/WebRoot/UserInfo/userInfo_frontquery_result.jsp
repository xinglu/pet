...
<%
    ...
    String createTime = (String)request.getAttribute("createTime"); //注册时间查询关键字
%>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="userInfoQueryForm" id="userInfoQueryForm" action="<%=basePath %>UserInfo/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				...
				<input type="text" id="createTime" name="createTime" class="form-control"  placeholder="请选择注册时间" value="<%=createTime %>" onclick="SelectDate(this,'yyyy-MM-dd')" />
			</div>
